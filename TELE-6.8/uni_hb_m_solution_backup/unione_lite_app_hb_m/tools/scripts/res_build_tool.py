...
STUDY_GRAMMAR_DATA = "./study.dat"
TARGET_STUDY_GRAMMAR_DATA_FILE = "../../include/grammar_study.h"
...
TARGET_NUL_CONTENT_TYPE_H_FILE = "../../include/uni_nlu_content_type.h"
...
def _create_grammar_array(ctrl):
    ...
    _bin_2_array(STUDY_GRAMMAR_DATA, "global_kws_lp_study_grammar", TARGET_STUDY_GRAMMAR_DATA_FILE)
