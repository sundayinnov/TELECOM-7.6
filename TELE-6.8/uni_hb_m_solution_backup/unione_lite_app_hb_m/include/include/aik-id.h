...
#define AIK_SUBTYPE_FREQ_SSP ((uint8_t)0x13)
#define AIK_SUBTYPE_END ((uint8_t)0x14)
...
#define AIK_ID_KWS_LP_SET_STUDY_MODE (AIK_ID_KWS_LP | (uint16_t)0x000f)
#define AIK_ID_KWS_LP_GET_STUDY_GRAMMAR (AIK_ID_KWS_LP | (uint16_t)0x0010)
#define AIK_ID_KWS_LP_GET_GRAMMAR_COMPARE (AIK_ID_KWS_LP | (uint16_t)0x0011)
#define AIK_ID_KWS_LP_GET_GRAMMAR_MERGE (AIK_ID_KWS_LP | (uint16_t)0x0012)
...
/* ID of FREQ SSP */
#define AIK_ID_FREQ_SSP \
  (((AIK_MAIN_ENGINE & 0xFF) << 24) | (AIK_SUBTYPE_FREQ_SSP & 0xFF) << 16)
/* 设置唤醒后的参数 */
#define AIK_ID_SSP_SET_WAKEUP_ARGS (AIK_ID_FREQ_SSP | (uint16_t)0x01)
