...
../user/src/examples/doa_uart.c \
../user/src/examples/user_adc_gp2y.c
...
./user/src/examples/doa_uart.o \
./user/src/examples/user_adc_gp2y.o
...
./user/src/examples/doa_uart.d \
./user/src/examples/user_adc_gp2y.d
